...
enum TColorProfile { CP_MONO, CP_STANDARD, CP_COLOR, CP_MULTICOLOR };
...
enum TMenuQueryType { GUI_QUERY_CANCEL = (uint16_t)-1, GUI_QUERY_NONE = (uint16_t)0, GUI_QUERY_YES, GUI_QUERY_SAVE, GUI_QUERY_DONTSAVE };
