/*  ChipMemoryMato.h: Derived class for memory management of Mato
...
*/
//---------------------------------------------------------------------------
#ifndef ChipMemoryMatoH
#define ChipMemoryMatoH
//---------------------------------------------------------------------------
#include "ChipMemory.h"
//---------------------------------------------------------------------------
class ChipMemoryMato : public ChipMemory {
public:
	ChipMemoryMato(BYTE initRomSizeKB, bool hasRAM64kB = false);
